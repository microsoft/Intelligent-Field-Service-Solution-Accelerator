...
To disable this, simply remove the following section from anomaly detection [azureDeploy.json](./Anomaly_Detection/Deployment/Templates/azureDeploy.json) before deploying the resources to Azure: 
